<template>
  <div class="tab-view">
    <h2>Upgrades</h2>
    <p class="tab-description">Melhore seu poder de clique e o rendimento geral da sua mineração!</p>
    <ul>
      <li
      ...
      >
        <div class="item-info">
          <strong>{{ upgrade.name }}</strong> ({{ upgrade.owned }})
        ...
        <button
          ...
          class="buy-button"
        >
          Comprar ({{ formatNumber(upgrade.cost) }})
        </button>
      </li>
    </ul>
  </div>
